...
export const ContentParamType ={
	CPT_NONE: 0x00,
	CPT_LIGHT: 0x01
};

export const ContentParamType2 = {
	CPT2_NONE: 0x00,
	// Need 8-bit param2
	CPT2_FULL: 0x01,
...
export class NodeDefinition {
    constructor(){
        this.tileDefs = new Array(6);
        this.tileDefOverlays = new Array(6);
        this.tileSpecial = new Array(6);
        this.groups = {};
        this.connectsToId = [];
    }
...
export class ServerNodeDefinitions {
    constructor(){
        this.definitions = [];
        this.nodeMapping = {};
    }
